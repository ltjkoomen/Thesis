...
class Simulation(nn.Module):
    ...
    def __init__(self):
        ...
        self.SimulationParameters['StoppingBounds'] = (0.1, 1000)
...
ss_state0 = Variable(torch.from_numpy(np.array([20., -0.0])).float())
